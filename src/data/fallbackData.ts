import type { AnnualDirection, AnnualZodiacInfo } from '../types';

/** 2026 丙午马年九宫飞星方位（源自大师公开文章整理，作为抓取失败时的兜底） */
export const FALLBACK_YEAR = 2026;
export const FALLBACK_YEAR_GANZHI = '丙午';
export const FALLBACK_YEAR_SHENGXIAO = '马';

export const FALLBACK_DIRECTIONS: AnnualDirection[] = [
...
export const ELEMENT_PLACES: Record<string, string> = {
...
export const FALLBACK_ZODIAC: Record<string, AnnualZodiacInfo> = {
